...
$fields[SYSLOG_SEVERITY]['FieldCaption'] = 'Level';
...
$fields[SYSLOG_EVENT_LOGTYPE]['Sortable'] = false;
$fields[SYSLOG_EVENT_LOGTYPE]['DefaultWidth'] = "200";
$fields[SYSLOG_EVENT_LOGTYPE]['FieldAlign'] = "left";
$fields[SYSLOG_EVENT_LOGTYPE]['SearchField'] = "eventlogtype";
$fields[SYSLOG_EVENT_LOGTYPE]['SearchOnline'] = false; 
...
$fields[SYSLOG_EVENT_SOURCE]['Sortable'] = false;
$fields[SYSLOG_EVENT_SOURCE]['DefaultWidth'] = "200";
$fields[SYSLOG_EVENT_SOURCE]['FieldAlign'] = "left";
$fields[SYSLOG_EVENT_SOURCE]['SearchField'] = "eventlogsource";
$fields[SYSLOG_EVENT_SOURCE]['SearchOnline'] = false; 
...
$dbmapping['syslogng'][SYSLOG_FACILITY] = "Facility";
$dbmapping['syslogng'][SYSLOG_SEVERITY] = "Priority";
